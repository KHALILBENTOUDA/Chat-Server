...
process.on("unhandledRejection", (err) => {
  ...
  // Since we're in a serverless environment, you might not need to close the server explicitly
  // Instead, you can log the error and let the environment handle it
  // However, you can still log if needed
});
